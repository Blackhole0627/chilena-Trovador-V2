        ...
        <div class="col-lg-5 second">
          <form action="{{ url()->current() }}" method="post" enctype="multipart/form-data" id="addStoryForm">
            ...
            <div class="form-group position-relative">
              ...
              <div>
                <span class="triggerEmoji" style="top: 10px; right: 8px; cursor: pointer;" data-toggle="dropdown" id="dropdownEmojiStory" aria-haspopup="true" aria-expanded="false" role="button">
                  <i class="bi-emoji-smile"></i>
                </span>

                <div class="dropdown-menu dropdown-menu-right dropdown-emoji custom-scrollbar" aria-labelledby="dropdownEmojiStory">
