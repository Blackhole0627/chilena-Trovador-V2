            ...
            <form action="{{ url('comment/live') }}" method="post" accept-charset="UTF-8" id="formSendCommentLive" enctype="multipart/form-data">
              ...
              @csrf
                  ...
                  <div class="d-flex">
                    ...
                    @if ($live && ! $paymentRequiredToAccess)
                      <div class="dropup d-inline-block position-relative">
                        <button type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" id="dropdownEmoji" class="btn icons-live e-none align-bottom buttons-live @if (auth()->user()->dark_mode == 'off') text-primary @else text-white @endif rounded-pill">
...
@section('javascript')
  ...
  @if ($live && $paymentRequiredToAccess)
    ...
    $(document).ready(function() {
  		var payModal = new bootstrap.Modal(document.getElementById('payLiveForm'), {
  				 backdrop: 'static',
  				 keyboard: false
  		});
        payModal.show();
