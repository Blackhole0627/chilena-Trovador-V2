		...
		<div class="media position-relative pt-3 border-top">
			...
			<div class="media-body">
				...
				<form action="{{url('comment/store')}}" method="post" @class(['comments-form', 'd-none' => !$response->creator->allow_comments])>
					...
					<span style="position: relative;">
					<span class="triggerEmoji" data-toggle="dropdown" id="dropdownEmoji{{ $response->id }}" aria-haspopup="true" aria-expanded="false" role="button" style="font-size:20px; cursor: pointer;">
						<i class="bi-emoji-smile"></i>
					</span>

				<div class="dropdown-menu dropdown-menu-right dropdown-emoji custom-scrollbar" aria-labelledby="dropdownEmoji{{ $response->id }}">
