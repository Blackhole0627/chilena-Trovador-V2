    ...
    <div class="modal-content modal-content-call border-0 text-center p-4">
      <div class="modal-body">
        ...
        <div class="form-check retracto-call-check text-left mt-3 mb-2">
          <input type="checkbox" class="form-check-input" id="checkRetractoVideoCall">
          <label class="form-check-label small" for="checkRetractoVideoCall">{{ __('general.accept_retracto') }}</label>
        </div>
